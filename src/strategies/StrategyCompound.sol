...
abstract contract StrategyCompound is Strategy {
    ...
    function totalAssets() public view override returns (uint256) {
        (uint256 errorCode, uint256 balance, uint256 borrowed, uint256 exchangeRate) =
    ...
    function _leverage(uint256 _supplied, uint256 _borrowed, uint256 _targetSupply, uint256 _marketCollateralRatio)
        internal
    {
        uint8 iterations;
    ...
    function _getBorrowAmount(uint256 _supplied, uint256 _borrowed, uint256 _marketCol)
        internal
        pure
        returns (uint256)
    {
    ...
    function _getRedeemAmount(uint256 _supplied, uint256 _borrowed, uint256 _marketCol)
        internal
        pure
        returns (uint256)
    {
